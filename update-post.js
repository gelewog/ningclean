...
const newContent = `
<div class="not-prose blog-article-content" style="color: inherit;">
  <style>
  ...
  <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 mb-6">
    ...
    <div class="leading-relaxed">
      ...
      <div class="bg-emerald-50 dark:bg-emerald-900/50 border-l-4 border-emerald-500 p-4 rounded-r-lg">
        <strong class="text-emerald-800 dark:text-emerald-300">💡 Pro Tip:</strong> <span class="text-slate-700 dark:text-slate-300">Siapkan tempat sampah kecil di setiap kamar dan ruang utama. Ini memudahkanmu untuk langsung membuang sampah tanpa harus jalan jauh ke tempat sampah besar.</span>
      </div>
    </div>
  </div>
  ...
  <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 mb-6">
    ...
    <div class="leading-relaxed">
      ...
      <div class="bg-sky-50 dark:bg-sky-900/30 border border-sky-200 dark:border-sky-800 rounded-xl p-4">
        <strong class="text-sky-800 dark:text-sky-300">🧽 Rekomendasi:</strong> <span>Gunakan lap mikrofiber untuk hasil terbaik. Lap ini lebih efektif menangkap debu dan noda tanpa meninggalkan serat.</span>
      </div>
    </div>
  </div>
