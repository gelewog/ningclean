UPDATE "BlogPost" SET content = '<div class="not-prose blog-article-content" style="color: inherit;">
  <style>
...
</script>', "readTime" = 8, "updatedAt" = NOW() WHERE id = '01b9b1ab-a068-4698-aeff-d0879c0459ff';