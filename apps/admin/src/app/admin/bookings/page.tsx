        ...
        <AnimatePresence>
          ...
          <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-0 sm:p-6 pointer-events-none">
            <motion.div
              ...
              className="pointer-events-auto w-full h-full sm:h-auto sm:max-w-4xl sm:max-h-[90vh] bg-white dark:bg-slate-900 sm:rounded-2xl shadow-2xl border-0 sm:border border-gray-200 dark:border-slate-700 overflow-hidden flex flex-col"
