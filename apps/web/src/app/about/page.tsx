      ...
      <main>
        ...
        <section className="relative py-32 overflow-hidden">
          <div className="pointer-events-none select-none">
            <div className="absolute top-0 left-1/4 w-[400px] h-[400px] rounded-full bg-emerald-500/[0.1] blur-[110px]" />
            <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] rounded-full bg-blue-600/[0.08] blur-[100px]" />
          </div>
          ...
          <div className="relative container mx-auto px-6 max-w-5xl">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full
                              ...
                              text-[12px] font-semibold text-emerald-400 tracking-widest uppercase mb-6">
                Tentang Ningclean
              </div>
              <h1 className="font-serif text-4xl md:text-5xl font-normal text-white mb-6">
                Membersihkan Rumah,{' '}
                <em className="italic text-emerald-400">Membangun Kepercayaan</em>
              </h1>
            ...
            >
              {defaultStats.map((stat, idx) => (
                <motion.div
                  key={idx}
                  variants={motionItem}
                  className="page-section-card border rounded-2xl p-6 text-center"
                >
        ...
        <section className="relative py-24">
          <div className="pointer-events-none select-none">
            <div className="absolute top-1/2 left-0 w-[350px] h-[350px] rounded-full bg-blue-600/[0.06] blur-[100px]" />
          </div>
          <div className="relative container mx-auto px-6 max-w-5xl">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                <h2 className="font-serif text-3xl md:text-4xl font-normal text-white mb-6">
                  Cerita <em className="italic text-emerald-400">Ningclean</em>
                </h2>
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="page-section-card border rounded-3xl p-8">
                  <div className="bg-gradient-to-br from-emerald-500/10 to-blue-600/10 rounded-2xl p-8 mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="page-section-card rounded-xl p-4">
                      <p className="text-2xl font-bold text-white">4.95</p>
                      <p className="text-[12px] text-white/40">Rating Google</p>
                    </div>
                    <div className="page-section-card rounded-xl p-4">
                      <p className="text-2xl font-bold text-white">500+</p>
                      <p className="text-[12px] text-white/40">Testimoni Positif</p>
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <section className="relative py-24">
          <div className="pointer-events-none select-none">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-emerald-500/[0.06] blur-[120px]" />
          </div>
          <div className="relative container mx-auto px-6 max-w-5xl">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <h2 className="font-serif text-3xl md:text-4xl font-normal text-white">
                Misi & <em className="italic text-emerald-400">Visi</em>
              </h2>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="page-section-card border rounded-3xl p-8"
              >
                <div className="w-14 h-14 rounded-2xl bg-emerald-500/10 flex items-center justify-center mb-6">
                  <span className="text-3xl">🎯</span>
                </div>
                <h3 className="font-serif text-2xl font-normal text-white mb-4">Misi Kami</h3>
              ...
              >
                ...
                <h3 className="font-serif text-2xl font-normal text-white mb-4">Visi Kami</h3>
                <p className="text-[15px] text-white/50 leading-relaxed">
        ...
        <section className="relative py-24">
          <div className="pointer-events-none select-none">
            <div className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-emerald-500/[0.07] blur-[110px]" />
          </div>
          <div className="relative container mx-auto px-6 max-w-5xl">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <h2 className="font-serif text-3xl md:text-4xl font-normal text-white mb-4">
                Tim <em className="italic text-emerald-400">Kami</em>
              </h2>
              <p className="text-[15px] text-white/45 max-w-xl mx-auto">
        ...
        <section className="relative py-24">
          <div className="pointer-events-none select-none">
            <div className="absolute top-1/2 left-1/4 w-[350px] h-[350px] rounded-full bg-blue-600/[0.05] blur-[100px]" />
          </div>
          <div className="relative container mx-auto px-6 max-w-5xl">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <h2 className="font-serif text-3xl md:text-4xl font-normal text-white mb-4">
                Mengapa <em className="italic text-emerald-400">Memilih Kami</em>
              </h2>
            </motion.div>
            ...
            >
              {whyChoose.map((item, idx) => (
                <motion.div
                  key={idx}
                  variants={motionItem}
                  className="page-section-card border rounded-2xl p-6 hover:border-emerald-500/20 transition-colors"
                >
        ...
        <section className="relative py-24 overflow-hidden">
          <div className="pointer-events-none select-none">
            <div className="absolute top-0 left-1/4 w-[380px] h-[380px] rounded-full bg-emerald-500/[0.1] blur-[110px]" />
            <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] rounded-full bg-blue-600/[0.08] blur-[100px]" />
          </div>
          ...
          <div className="relative container mx-auto px-6 max-w-5xl">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-center page-section-card border rounded-3xl p-12"
            >
              <h2 className="font-serif text-3xl md:text-4xl font-normal text-white mb-4">
                Siap <em className="italic text-emerald-400">Booking?</em>
              </h2>
