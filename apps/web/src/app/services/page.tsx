...
import { ArrowRight, CheckCircle, Search, Grid3X3, List, X, ChevronDown } from 'lucide-react';
                    ...
                    <AnimatePresence>
                      {showSortDropdown && (
                        <motion.div
                          ...
                          className="absolute top-full mt-2 right-0 w-64 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-200 dark:border-slate-700 py-2 z-50"
                        >
