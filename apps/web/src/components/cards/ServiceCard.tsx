      ...
      <Link href={`/booking?service=${service.id}`}>
        <div className="group relative page-card border rounded-2xl overflow-hidden h-full hover:border-emerald-500/20 transition-all duration-300">
          ...
          <div className="p-5">
            ...
            {/* Footer */}
            <div className="flex flex-wrap items-center justify-between gap-2 pt-3 border-t page-border">
              <div className="flex items-center gap-3 page-text-muted text-[12px]">
